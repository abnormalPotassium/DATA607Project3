...
SELECT b.business_title, b.job_category, s.job_description, s.minimum_qual, s.preferred_skills
...
search_keywords <- function(df, keywords, category) {
  ...
  for (i in 1:nrow(df)) {
    ...
    text <- tolower(paste(df[i, ], collapse = " "))
    ...
    for (j in 1:length(keywords)) {
      ...
      if (stri_detect_regex(text, paste0("\\b", keywords[j], "\\b"), case_insensitive = TRUE)) {
...
data_acq_keys <- c("SQL", "data acquisition", "database", "cloud storage", "API", "data entry", "data scraping", "scraping", "mongodb", "postgre", "mariadb", "oracle", "signal reception", "data extraction", "web scraping", "etl", "data collection", "web crawling", "database management", "data warehouse" )
data_prep_keys <- c("Alteryx", "Knime", "Excel", "data engineering", "preprocessing", "data preparation", "data cleaning", "data wrangling", "data transformation", "data integration", "normalization", "imputation", "data formatting", "data merging", "data enrichment")
data_exp_keys <- c("Tableau", "Excel", "data analysis", "feature selection", "data engineering", "data exploration", "EDA", "Descriptive Statistics", "Data Profiling", "Data Quality Assessment", "Data Sampling", "Dimensionality Reduction", "Feature Engineering", "Correlation Analysis", "Outlier Detection", "Pattern Identification")
data_anal_keys <- c("Excel", "data modeling", "machine learning", "data analysis", "artificial intelligence", "qualitative analysis", "predictive analysis", "regression", "Statistical Analysis", "Machine Learning","Classification", "Clustering", "Time Series", "Hypothesis Testing", "A/B Testing", "Data Mining" )
data_vis_keys <- c("Tableau", "PowerBI", "data insights", "quantitative findings", "graph creation", "data reporting", "data visualization", "busines intelligence", "Data Storytelling", "Data Presentation","Information Design", "Dashboard Creation", "Charting","Infographics", "Data Visualization Tools", "Interactive Data Visualization")

data_science_categories <- c(data_acq_keys, data_prep_keys, data_exp_keys, data_anal_keys, data_vis_keys)
...
In order to be able to truly relate the keywords within each column to other information within the dataset, we will need to create new columns on the dataset that count matches for each data science skill type. We have broken down data science skills into the following categories:
