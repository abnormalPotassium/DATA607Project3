...
- Including estimates for hourly and daily workers, the median salary was $75,000 per year, while the mean was $76,716. The minimum was $30,000 and the maximum was $230,000.
...
- If you're interested in pursuing a data science job, there are many different NYC agencies which offer opportunities. 

While the top data science job agencies tended to be explicitly related to Technology, Data, or Engineering, there were many "qualitative" fields which also requested data science skills. For example, 

nyc_jobs_combination2 <- nyc_jobs_combination %>% filter(total_datascience_keywords > 0)
nyc_2 <- as.data.frame(table(nyc_jobs_combination2$job_category))

write_csv(nyc_2,"C\\users\\rossboehme\\Desktop\\nyc_2.csv")
